...
int main() {
    ...
    do {
        ...
        if (mode == '1') {
            ...
            //Вибір користувачем текстового файлу (із підготовлених)
